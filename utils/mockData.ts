...
import { APIClanMemberList } from "../types/api";
...
export const mockClanMemberList: APIClanMemberList = [
  {
    tag: "#29LVR2YUV",
    name: "Ramos",
    role: "coLeader",
